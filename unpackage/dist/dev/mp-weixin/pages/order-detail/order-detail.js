...

{
  ...
  getOrderDetail: function getOrderDetail(orderNo) {var _this = this;
    ...
    then(function (res) {
      ...
      if (_this.orderDetail.orderStatus === 1) {
        _this.setOrderInvalidationTime(_this.orderDetail.payTime);
      }
    });
  },
