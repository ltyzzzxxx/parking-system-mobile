...
/* harmony import */ var _order_detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order-detail.vue?vue&type=style&index=0&lang=css& */ 412);
...
try {
  components = {
    ...
    minCountdown: function() {
      return __webpack_require__.e(/*! import() | components/min-countdown/min-countdown */ "components/min-countdown/min-countdown").then(__webpack_require__.bind(null, /*! @/components/min-countdown/min-countdown.vue */ 537))
    },
    wybPopup: function() {
...
var _moment = _interopRequireDefault(__webpack_require__(/*! moment */ 267));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var minCountdown = function minCountdown() {__webpack_require__.e(/*! require.ensure | components/min-countdown/min-countdown */ "components/min-countdown/min-countdown").then((function () {return resolve(__webpack_require__(/*! @/components/min-countdown/min-countdown.vue */ 537));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var wybPopup = function wybPopup() {__webpack_require__.e(/*! require.ensure | components/wyb-popup/wyb-popup */ "components/wyb-popup/wyb-popup").then((function () {return resolve(__webpack_require__(/*! @/components/wyb-popup/wyb-popup.vue */ 530));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { wybPopup: wybPopup, minCountdown: minCountdown }, data: function data() {return { orderDetail: {}, orderNo: '', targetTime: '' };}, computed: { enterTime: function enterTime() {var formatTime = (0, _moment.default)(parseInt(this.orderDetail.startTime * 1000)).format('yyyy-MM-DD HH:mm:ss');return formatTime;} }, methods: { callback: function callback() {this.getOrderDetail(this.orderNo);}, continuePay: function continuePay() {var _this = this;uni.showModal({ content: '是否确认支付？', showCancel: true, success: function success(res) {if (res.confirm) {_this.$api.payOrder({ orderNo: _this.orderNo }).then(function (res) {uni.showToast({ title: '支付成功', icon: 'none' });_this.getOrderDetail(_this.orderNo);});} else {console.log("取消支付");}} });}, cancelPay: function cancelPay() {var _this2 = this;uni.showModal({ content: '是否取消订单？', showCancel: true, success: function success(res) {if (res.confirm) {_this2.$api.cancelOrder({ orderNo: _this2.orderNo }).then(function (res) {uni.showToast({ title: '取消订单成功', icon: 'none' });_this2.getOrderDetail(_this2.orderNo);});}} });}, makePhoneCall: function makePhoneCall() {uni.makePhoneCall({ phoneNumber: '19903581356', success: function success(res) {console.log("调用成功");}, fail: function fail(err) {console.log("调用失败");} });}, showHelp: function showHelp() {this.$refs.popup.show();}, getOrderDetail: function getOrderDetail(orderNo) {var _this3 = this;this.$api.getOrderDetail({ orderNo: orderNo }).then(function (res) {console.log(res);_this3.orderDetail = res.orderDetail;if (_this3.orderDetail.orderStatus === 1) {_this3.setOrderInvalidationTime(_this3.orderDetail.payTime);}});}, setOrderInvalidationTime: function setOrderInvalidationTime(payTime) {var date = payTime;date = date.substring(0, 19);date = date.replace(/-/g, '/'); //必须把日期'-'转为'/'
      this.targetTime = new Date(date).getTime() + 900000;} }, onLoad: function onLoad(option) {console.log(option.orderNo);this.orderNo = option.orderNo;this.getOrderDetail(option.orderNo);} };exports.default = _default;
