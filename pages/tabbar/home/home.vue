	...
	<view class="animate__animated animate__fadeInDown">
		...
		<view class="position-relative">
			<view class="flex p-3" v-if="!user" @click="navigateTo('/pages/login/login')">
				<image src="/static/parking_lot.png" style="width: 120rpx; height: 120rpx;" class="rounded-circle bg-light"></image>
			...
			<view class="flex align-center p-3" v-else @click="authJump('/pages/user-info/user-info')">
				...
				<view class="flex flex-column pl-3 flex-1 text-white">
					...
					<view class="font-sm">{{user.desc || '我是一个小可爱！'}}</view>
				</view>
			...
			<view class="px-3">
				<uni-list :border="false">
					<uni-list-item clickable title="自助缴费" showArrow>
						<text slot="header" class="iconfont icon-zizhujiaofei mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
					<uni-list-item clickable title="停车记录" showArrow>
						<text slot="header" class="iconfont icon-jilu mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
					<uni-list-item clickable title="预约记录" showArrow>
						<text slot="header" class="iconfont icon-yuyue mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
					<uni-list-item clickable title="账单记录" showArrow>
						<text slot="header" class="iconfont icon-zhangdan mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
					
					<view class="divider"></view>
					
					<uni-list-item clickable title="联系客服" @click="makePhoneCall" showArrow>
						<text slot="header" class="iconfont icon-kefu mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
					<uni-list-item clickable title="设置" showArrow @click="navigateTo('/pages/setting/setting')">
						<text slot="header" class="iconfont icon-shezhi mr-2" style="font-size: 20px; color: #4396ec;"></text>
					</uni-list-item>
				</uni-list>
			</view>
		</view>
